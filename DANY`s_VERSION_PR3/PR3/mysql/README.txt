...
1) importa el fichero reversebid.sql desde phpMyAdmin (estructura de la base de datos
2) escoge la base de datos "reversebid" y ve nuevamente a importar, e importa el fichero 
	de creación de usuario "rb_user"
